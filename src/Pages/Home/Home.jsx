...
export default function Home() {
  return (
    <>
      <div>
        <div className="flex justify-center pt-[100px] flex-col items-center w-full mt-[-40%] relative">
              ...
              <div className="flex flex-col pt-[460px] gap-[60px]">
                <div className="flex flex-col justify-center items-center gap-[24px]">
                  ...
                  <p className="font-[400] max-w-[504px] text-[#6D7379] text-[22px]">
                    ...
                    in-person visit consultation, we're here to connect you with
                    the right care—fast, simple, and secure.
                  </p>
                  ...
                  >
                    ...
                    <div className="w-full h-[93px] absolute left-0 bottom-0 bg-white shadow-[0_0_13px_0_rgba(0,0,0,0.1)] flex flex-col gap-[4px] p-[16px] justify-start items-start ">
                      ...
                      <p className="font-[400] text-[10px] text-start text-[#404448]">
                        Easily browse by specialty, location, or doctor name to
            ...
            <div className="flex items-center justify-between">
              <div className="max-w-[692px] text-start">
                ...
                <p className="font-[400] text-[22px] text-[#6D7379]">
                  ...
                  for their expertise, care, and service. Book with confidence
                  today.
                </p>
              </div>
          ...
          <div className="h-[350px] hidden md:block w-full relative">
            <div className="z-30 flex justify-center gap-[60px] items-center py-[40px] px-[60px] h-[320px] w-[85%] bg-[#6292CF] absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-25%] rounded-[20px] ">
